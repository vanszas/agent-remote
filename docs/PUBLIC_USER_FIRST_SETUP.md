...
Tekan **Tambahkan ke Desktop + Start Menu** untuk memasang control center pada lokasi stabil `%LOCALAPPDATA%\AgentRemote\bin`. Shortcut user dibuat pada Desktop dan Start Menu tanpa izin Administrator.
